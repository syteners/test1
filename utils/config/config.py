...
def create_config():
    ...
    config.set("Settings", "bot_token", "5015465162:AAG9FxkKBT1mq8YZ35ae4LMu_Tv0CiAT9Do")
    config.set("Settings", "admin_group", "-1001287354289")
    config.set("Settings", "admin_id", "5078650590, 5194214731, 891483443")
